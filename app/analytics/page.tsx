...
import { Badge, TrendingUp, Users, DollarSign, Activity } from 'lucide-react';
import {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (data) {
                ...
                // Calculate KPIs
                const totalRev = data.reduce((sum, c) => sum + (c.total_spent || 0), 0);
        ...
        <div className="max-w-7xl mx-auto space-y-8 pb-20">
                ...
                <GlassCard className="p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-white">{format(stats.aov)}</p>
                        </div>
                    </div>
                </GlassCard>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="col-span-1 lg:col-span-2">
                    <BudgetSimulator historicalRevenue={stats.totalRevenue} />
                </div>
